...
import com.example.savecontact.Database.PreferenceManager;
import com.example.savecontact.Database.SqliteHelper;
import com.example.savecontact.Database.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  createNotificationChannel();
        mNotificationManagerCompat = NotificationManagerCompat.from(LoginActivity.this);
...
//
//
//                Notification notification = new NotificationCompat.Builder(LoginActivity.this, CHANNEL_ID)
...
//                mNotificationManagerCompat.notify(1, notification);
    ...
    private void initCreateAccountTextView() {
        ...
        textViewCreateAccount.setText(fromHtml("<font color='#ffffff'>I don't have account yet. </font><font color='#ffffff'>Register</font>"));
